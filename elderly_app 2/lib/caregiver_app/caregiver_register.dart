...
import 'package:elderly_app/langauages/chinese_page_caregiver.dart';
...
class caregiverRegister extends StatefulWidget {
  const caregiverRegister({super.key});

  @override
  State<caregiverRegister> createState() => _caregiverRegisterState();
}

class _caregiverRegisterState extends State<caregiverRegister> {
  ...
  Future<void> addData(String name, String email, number) async {
    ...
    // print("addData called with name: $name, email: $email, number: $number");
    if (name == "" || email == "" || number == "") {
      ...
      // print("Setting data in Firebase");
      await ref.set({
        "Name": name,
        "Email": email,
        "PhoneNumber": number,
      ...
      print("Navigating to caregiverHome");
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (BuildContext context) => caregiverHome(
